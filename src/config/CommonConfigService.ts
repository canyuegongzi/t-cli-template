...
const devConfig = fs.readFileSync(join(__dirname, './env', 'application.dev.yaml'), 'utf-8');
const proConfig = fs.readFileSync(join(__dirname, './env', 'application.pro.yaml'), 'utf-8');
